...
export default function PermissionChangeLogMockup() {
  ...
  // Flatten data: one row per affected user
  const flattenedData = mockChangeLogData.flatMap(row =>
    row.affectedUsers.map((user, idx) => ({
      id: `${row.id}-${idx}`,
  ...
  const filteredData = flattenedData.filter(row => {
    const matchesSearch =
      ...
      row.affectedUser.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    const matchesAffectedUser = !affectedUserFilter ||
      row.affectedUser.toLowerCase().includes(affectedUserFilter.toLowerCase());
  ...
  const allAffectedUsers = [...new Set(flattenedData.map(r => r.affectedUser))].sort();
          ...
          <div style={{ background: "#fff", border: `1px solid ${colors.border}`, borderRadius: 8, padding: 16, marginBottom: 20 }}>
            <div style={{ display: "flex", gap: 12, alignItems: "center", marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", flexShrink: 0 }}>
                ...
                <div style={{ fontSize: 9, color: colors.textMuted, marginTop: 2, whiteSpace: "nowrap" }}>
            ...
            <div style={{ display: "flex", gap: 24, marginTop: 16, paddingTop: 16, borderTop: `1px solid ${colors.border}` }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 20, fontWeight: 600, color: colors.text }}>
                  {new Set(filteredData.map(r => r.affectedUser)).size}
                </div>
              </div>
            </div>
          </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "#f9fafb", borderBottom: `2px solid ${colors.border}` }}>
                    <th style={{ padding: "12px 10px", width: "140px", textAlign: "left", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Timestamp
                    </th>
                    <th style={{ padding: "12px 10px", width: "140px", textAlign: "left", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Changed By
                    </th>
                    <th style={{ padding: "12px 10px", textAlign: "left", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                      Permission
                    </th>
                    <th style={{ padding: "12px 8px", width: "80px", textAlign: "center", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Type
                    </th>
                    <th style={{ padding: "12px 8px", width: "100px", textAlign: "center", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Previous
                    </th>
                    <th style={{ padding: "12px 8px", width: "100px", textAlign: "center", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      New
                    </th>
                    <th style={{ padding: "12px 8px", width: "90px", textAlign: "center", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Group
                    </th>
                    <th style={{ padding: "12px 10px", width: "140px", textAlign: "left", fontSize: 11, fontWeight: 600, color: colors.textMuted, textTransform: "uppercase", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                      Affected User
